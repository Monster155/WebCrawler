...
doc = Doc(search_request[0] + " " + search_request[2])
doc.segment(segmenter)
doc.tag_morph(morph_tagger)
doc.tokens[0].lemmatize(morph_vocab)
doc.tokens[1].lemmatize(morph_vocab)
search_request[0] = doc.tokens[0].lemma.lower()
search_request[2] = doc.tokens[1].lemma.lower()
